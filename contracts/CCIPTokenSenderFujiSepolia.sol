...
contract CCIPTokenSenderFujiSepolia {
    ...
    // LINK CONTRACT ADDRESS ON AVALANCHE FUJI
    // https://docs.chain.link/resources/link-token-contracts#fuji-testnet
    address linkOnAvalanche = 0x0b9d5D9136855f6FEc3c0993feE6E9CE8a297846;
    // ROUTER CONTRACT ADDRESS OF AVALANCHE FUJI
    ...
    // TEST TOKEN ADDRESS (Burn & Mint Token on Avalanche Fuji Testnet)
    ...
    constructor() {
        ...
        linkToken = LinkTokenInterface(linkOnAvalanche);
